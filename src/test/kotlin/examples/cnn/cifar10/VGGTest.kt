...
class VGGTest {
    private val PATH_TO_MODEL = "savedmodels/vgg11"
    private val EPOCHS = 1 // 10, at least, is recommended
    private val TRAINING_BATCH_SIZE = 128
    private val TEST_BATCH_SIZE = 1000
    private val NUM_LABELS = 10
    private val NUM_CHANNELS = 3L
    private val IMAGE_SIZE = 32L
    private val TRAIN_TEST_SPLIT_RATIO = 0.8
