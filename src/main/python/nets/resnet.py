...
if __name__ == "__main__":
    ...
    if version == 152:        
        base_model = tf.keras.applications.resnet_v2.ResNet152V2(weights="imagenet", include_top=False, input_shape=train['plot'][0].shape)    
    elif version == 101:
        base_model = tf.keras.applications.resnet_v2.ResNet101V2(weights="imagenet", include_top=False, input_shape=train['plot'][0].shape)
