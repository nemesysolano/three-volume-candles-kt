import datasets
import environment as directories
...
if __name__ == "__main__":
    ...
    if version == 16:
        ...
        base_model = tf.keras.applications.vgg19.VGG19(weights="imagenet", include_top=False, input_shape=train['plot'][0].shape)
    ...
    # modelIO.save_model(symbol, timeframe, model, y_hat, test['direction'])
